...
{
    class NPC_ShadowHunter : IEnemyObjects 
    {
        ...
        public NPC_ShadowHunter(Model m) // Constructor
        {
            model = m;
        }
        ...
        public void setBehavior(hunterBehavior b)
        {
            switch (b)
            {
                case hunterBehavior.Idle:
                    // have no state running in updater
                    break;
                case hunterBehavior.Passive:
                    // have "wandering" state running in updater
                    break;
                case hunterBehavior.Alarm:
                    // have "alert others" state running in updater
                    break;
                case hunterBehavior.Hostile:
                    // have beast target random player and attack
                    break;
                case hunterBehavior.Fleeing:
